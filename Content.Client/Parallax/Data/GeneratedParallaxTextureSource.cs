...
public sealed partial class GeneratedParallaxTextureSource : IParallaxTextureSource
{
    ...
    async Task<Texture> IParallaxTextureSource.GenerateTexture(CancellationToken cancel)
    {
        ...
        {
            ISawmill.Error("parallax", $"Parallax config not found or unreadable: {ParallaxConfigPath}");
            // The show must go on.
        ...
        {
            ISawmill.Error("parallax", $"Couldn't retrieve parallax cached texture: {ex}");
